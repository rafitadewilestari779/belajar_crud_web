...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_mhs (nama, npm, kls, jk, email, telp, alamat) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>Silahkan menambahkan data Mahasiswa baru pada form dibawah ini.</p>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="npm" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
...
do {  
?>
            <option value="<?php echo $row_rec_kls['kls']?>" ><?php echo $row_rec_kls['kls']?></option>
            <?php
